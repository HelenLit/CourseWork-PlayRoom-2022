...
public class LauncherImpl {
    ...
    private static final String MF_MAIN_CLASS = "org.example.Main-Class";
    ...
    public static void launchApplication(final String launchName,
        ...
        if (launchMode.equals(LAUNCH_MODE_JAR)) {
            ...
            if (mainClassName == null) {
                // fall back on org.example.Main-Class if no JAC
                mainClassName = jarAttrs.getValue(MF_MAIN_CLASS);
                if (mainClassName == null) {
                    // Should not happen as the launcher enforces the presence of org.example.Main-Class
                    abort(null, "JavaFX jar manifest requires a valid JavaFX-Appliation-Class or org.example.Main-Class entry");
                }
            }
