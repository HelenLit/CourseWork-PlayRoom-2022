...
public final class WebPage {
    ...
    // PAGE_LOCK is used to synchronize the following operations b/w Event & org.example.Main threads:
    // - rendering of the page (org.example.Main thread)
    // - native calls & other manipulations on the page (Event & org.example.Main threads)
    ...
    // Accessed on: Event thread and org.example.Main thread.
    ...
    private static final class RenderFrame {
        ...
        // Called on: Event thread and org.example.Main thread
    ...
    public long getMainFrame() {
        ...
        try {
            ...
            log.finer("org.example.Main frame = " + mainFrameID);
